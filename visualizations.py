...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--goodTrain_folder_path",
        type=str,
        required=True,
        help="Path to the 'good' training folder",
    )
    parser.add_argument(
        "--badTrain_folder_path",
        type=str,
        required=True,
        help="Path to the 'bad' training folder",
    )
