...
def split_data_and_copy_image(args):
    ...
    good_train_ids, good_val_ids = train_test_split([img['id'] for img in good_images], test_size=0.2)
    bad_train_ids, bad_val_ids = train_test_split([img['id'] for img in bad_images], test_size=0.2)
